...
vi.mock('discord.js', () => {
  ...
  class MockClient {
    ...
    user: any = { id: '999888777', tag: 'G2#1234' };
...
import { DiscordChannel, DiscordChannelOpts } from './DiscordChannel.js';
...
describe('DiscordChannel', () => {
  ...
  describe('@mention translation', () => {
    ...
    it('does not translate if message already matches trigger', async () => {
      ...
      const msg = createMessage({
        content: '@G2 hello <@999888777>',
        mentionsBotId: true,
        guildName: 'Server',
      });
      await triggerMessage(msg);

      // Should NOT prepend @G2 — already starts with trigger
