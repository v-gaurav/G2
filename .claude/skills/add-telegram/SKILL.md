...
This skill adds Telegram support to G2 using the skills engine for deterministic code changes, then walks through interactive setup.

## Phase 1: Pre-flight

### Check if already applied

Read `.g2/state.yaml`. If `telegram` is in `applied_skills`, skip to Phase 3 (Setup). The code changes are already in place.
...
>    - Bot name: Something friendly (e.g., "G2 Assistant")
>    - Bot username: Must end with "bot" (e.g., "g2_ai_bot")
...
> - For non-main: `@G2 hello` or @mention the bot
>
...
4. Service is running: `launchctl list | grep g2`
...
- Check bot is started: `tail -f logs/g2.log`
