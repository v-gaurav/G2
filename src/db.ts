...
/**
 * Atomically claim a task for execution by nullifying its next_run.
 * Returns true if the task was claimed (row was updated), false if
 * it was already claimed by another tick or paused/cancelled.
 */
