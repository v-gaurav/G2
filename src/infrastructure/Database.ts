...
import { ChatRepository } from '../messaging/MessageRepository.js';
import { GroupRepository } from '../groups/GroupRepository.js';
...
import { TaskRepository } from '../scheduling/TaskRepository.js';
import { RegisteredGroup } from '../types.js';

// ---------------------------------------------------------------------------
// Schema creation & migrations (moved from repositories/schema.ts)
// ---------------------------------------------------------------------------
...
/**
 * AppDatabase — composition root that initializes the DB and exposes repositories.
 */
